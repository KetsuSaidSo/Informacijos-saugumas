...
Paleidus sistemà pirmà kartà sukuriamas.csv arba.txt failas.
Iðjungiant sistemà ðis failas turi bûti uþðifruojamas AES algoritmu.Kità kartà paleidus sistemà failas yra deðifruojamas. (4 taðkai)

Naujo slaptaþodþio iðsaugojimas : uþpildþius formà(pavadinimas,
slaptaþodis, URL / aplikacija, komentaras), visa jos informacija saugojama.csv arba.txt faile.
Slaptaþodþiui pritaikomas ðifravimo algoritmas(pvz.: AES, DES ar RSA.Renkatës savo nuoþiûra). (3 taðkai)
...
Slaptaþodþio iðtrynimas pagal pavadinimà :
suradus tinkamà slaptaþodá visa informacija apie já iðtrinama ið.csv arba.txt failo. (2 taðkai)
